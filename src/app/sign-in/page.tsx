                ...
                <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                  ...
                  <form>
                    ...
                    <div className="mb-2">
                      ...
                      <div className="pt-2 mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                        <input
                          ...
                          id="checkboxDefault" />
                        <label
                          className="text-sm italic inline-block pl-[0.15rem] hover:cursor-pointer"
                    ...
                    <div className="mb-5">
                      ...
                      <FaArrowRight onClick={() => router.push('/')}  size={20} color="rgb(79 70 229)" />
                    </div>
                    </div>
                  
                    <button className="flex w-full font-bold text-black items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50">
                      <span>
                        <svg
                          width="20"
                          height="20"
