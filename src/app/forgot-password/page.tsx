                            ...
                            <div className=" flex flex-wrap items-center">
                                ...
                                <div className="w-full border-stroke xl:w-1/2 xl:border-l-2">
                                    <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                                        <h2 className="mb-1 text-2xl font-bold text-indigo-600 sm:text-title-xl2">
                                            Redefinir senha
                                        </h2>
                                        <h4 className="text-sm mb-8 italic">
                                            Digite seu e-mail para receber um
                                        ...
                                        <form>
                                            ...
                                            <div className="mb-5">
                                                <input
                                                    type="submit"
                                                    value="Enviar link de redefinição de senha"
