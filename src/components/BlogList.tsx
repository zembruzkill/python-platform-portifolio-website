        ...
        <>
            <div className="mx-auto max-w-7xl items-center pt-6 mb-8">
                <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                    ...
                    <p className="text-zinc-200 sm:text-xl ">
                        Explorando o Mundo da Programação Python: Dicas, Truques
                        e Inspiração para Tornar seu Código Mais Poderoso.
                    </p>
                </div>
                <div className="container mx-auto 2xl:flex xl:flex lg:flex gap-4">
                                            ...
                                            <div className="flex flex-col justify-between leading-normal pl-4">
                                                <div className="flex gap-2 pt-2">
                                                    {category
                                                        ...
                                                        .map(
                                                            (category_post) => (
                                                                <button className="p-1 bg-blue-200 text-zinc-700 rounded text-title-xxsm uppercase text-center flex items-center justify-center">
                                                                    {
                                                                        category_post
                                                                    }
                                                                </button>
                    ...
                    <div className="2xl:w-1/3 xl:w-1/3 lg:w-1/3 h-full flex flex-col gap-1 sm:w-full">
                        ...
                        <div className="border border-zinc-600 rounded-lg">
                            ...
                            <div className="p-4">
                                <p className="text-title-xxsm font-bold uppercase text-white">
                                    Destaques
                                </p>
                                <div className="pt-4">
                                                ...
                                                <li className="" key={slug}>
                                                    <div className="flex gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <h4 className="font-extralight pt-2 text-title-xsm text-blue-300">
                                                                {date}
                                                            </h4>
                                                        </div>
                                                    </div>
