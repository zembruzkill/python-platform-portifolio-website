    ...
    <footer className="bg-[#0D1224] dark:bg-gray-900">
        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Links rápidos</h2>
                ...
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Suporte</h2>
                    <ul className="text-white dark:text-gray-400">
                        <li className="mb-4">
                            <p className="">Precisa de ajuda? Envie um email para: contato@cursopython.pro</p>
                        </li>
                    </ul>
                </div>
                <div>
