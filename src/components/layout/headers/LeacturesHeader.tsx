      ...
      <nav className=" mx-auto flex items-center justify-between bg-gray-300 border-b border-[#1C1836]">
        ...
        <div className="flex w-5/6 justify-between p-4 gap-3">
          ...
          <div className='flex gap-3 '>
            <button className='text-white font-bold border border-[#1C1836] hover:border-white hover:text-zinc-400 rounded p-2 flex items-center'><span><FaAngleLeft /></span> <span className='2xl:block xl:block lg:block md:hidden sm:hidden xsm:hidden'>Aula Anterior</span></button>
            <button className='text-white font-bold bg-[#6432c7] hover:bg-[#7234EF] border border-[#A3A3A3] hover:border-white rounded p-2 flex items-center'><span className='2xl:block xl:block lg:block md:hidden sm:hidden xsm:hidden'>Proxima Aula</span><span><FaAngleRight /></span></button>
          </div>
        </div>
      </nav>
    </header>
