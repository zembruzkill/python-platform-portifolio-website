            ...
            {session && (
                <>
                                    ...
                                    <Popover.Panel className="absolute -left-8 top-full z-1 mt-3 overflow-hidden rounded bg-white shadow-lg ring-1 ring-white/5">
                                        <div className="">
                                            <div className="flex gap-2 p-4 bg-primary items-center">
                                                ...
                                                <p className="lex items-center gap-x-1 text-md font-bold leading-6 text-black">
                                                    {session?.user?.name}
                                                </p>
                                            </div>
                                            ...
                                            {profile_options.map((item) => (
                                                ...
                                                >
                                                    <div className="flex-auto">
                                                        <Link
                                                            href={item.href}
                                                            className="block text-md font-bold text-black hover:text-indigo-600"
                                                        >
                                                            {item.name}
                                                        </Link>
                                                    </div>
                        ...
                        {profile_options.map((item) => (
                            ...
                            >
                                <div className="flex-auto">
                                    <Link
                                        href={item.href}
                                        className="text-md font-bold text-white hover:text-indigo-600"
                                    >
                                        {item.name}
                                    </Link>
                                </div>
                    ...
                    <div className="flex gap-2 items-center">
                        <a
                            onClick={handleLogout}
                            className="p-4 block text-md font-bold text-white hover:text-indigo-600"
                        >
                            Sair
                        </a>
                        <span>
