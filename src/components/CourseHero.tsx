                        ...
                        <div className="flex flex-col lg:flex-row justify-between gap-2 relative">
                            <div className="max-w-xl text-center md:text-left pt-5 lg:pt-24">
                                <h1 className="mt-0 text-white text-title-xl font-bold">
                                    Programador Python Pro
                                </h1>
                                <p className="text-zinc-300 text-xl md:text-2xl leading-7 md:leading-9 my-5">
                                    Tudo o que você precisa para programar em
                                    Python em um único curso (inclui 3 projetos
                                    do mundo real)
                                </p>
                                <div className="my-8">
                                ...
                                <div className="mt-4 flex items-center justify-center md:justify-start">
                                    <hr className=" text-zinc-300 inline-block w-6 mr-2"></hr>
                                    <span className="text-zinc-300">ou</span>
                                    <hr className="text-zinc-300 inline-block w-6 ml-2"></hr>
                                </div>
                                <div>
                                    <a
                            ...
                            <div className="mt-7">
                                <div className="shadow-2xl shadow-gray-50 border border-zinc-600 rounded-md relative">
                                    ...
                                    <div className="p-6 md:p-10 lg:p-12 whitespace-nowrap bg-[#11152C] rounded">
                                        <h2 className="text-white font-semibold text-lg uppercase tracking-wide mb-0">
                                            Detalhes do Curso
                                        </h2>
