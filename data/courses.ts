const courses = [
    {
        ...
        imageSrc:
            'https://res.cloudinary.com/doorwkexf/image/upload/v1697163143/Python_para_Iniciantes_pflrov.png',
        ...
        description:
            'Quer ver se programar é para você? Esta é a mini faixa perfeita! Aprenda o básico do Python conosco.',
        modules: [
            {
